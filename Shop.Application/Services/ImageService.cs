...
public class ImageService : IImageService
{
    ...
    public async Task<ImageEntity> SaveImageAsync(IFormFile file, int productId, bool isMain = false)
    {
        ...
        var destinedPath = Path.Combine(basePath, "uploads", "productos", DateTime.Now.Year.ToString());
        ...
        var relativePath = Path.Combine("uploads", "productos", DateTime.Now.Year.ToString(), uniqueName);
